namespace TSODD.Views.FilmTypeView {
    partial class FilmTypeView {
		...
		private void InitializeComponent() {
            ...
            this.mainRibbonPageGroup.Text = "FilmType Tasks";
			// 
			...
			this.filmTypeViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.filmTypeViewBindingSource.DataSource = typeof(TSODD.Entity.Road_sign.FilmType);
			this.dataLayoutControl1.DataSource = filmTypeViewBindingSource;
			//
			//Create GridControls
			//
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.FilmTypeViewModel);
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.FilmTypeViewModel), "Save", bbiSave));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.FilmTypeViewModel), "SaveAndClose", bbiSaveAndClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.FilmTypeViewModel), "SaveAndNew", bbiSaveAndNew));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.FilmTypeViewModel), "Reset", bbiReset));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.FilmTypeViewModel), "Delete", bbiDelete));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.FilmTypeViewModel), "Close", bbiClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.FilmTypeViewModel), "SaveLayout", bbiSaveLayout));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.FilmTypeViewModel), "ResetLayout", bbiResetLayout));
		...
		private System.Windows.Forms.BindingSource filmTypeViewBindingSource;
