namespace TSODD.Views.FilmTypeCollectionView {
    partial class FilmTypeCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "FilmType Tasks";
			...
			this.filmTypeCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.filmTypeCollectionViewBindingSource.DataSource = typeof(TSODD.Entity.Road_sign.FilmType);
			this.gridControl.DataSource = filmTypeCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnsParameters parameters = new DevExpress.XtraGrid.Extensions.PopulateColumnsParameters();
						...
						this.gridView.PopulateColumns(typeof(TSODD.Entity.Road_sign.FilmType),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.FilmTypeCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.FilmTypeCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.FilmTypeCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.FilmTypeCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.FilmTypeCollectionViewModel), "Refresh", bbiRefresh));
            ...
            this.Name = "FilmTypeCollectionView";
		...
		private System.Windows.Forms.BindingSource filmTypeCollectionViewBindingSource;
