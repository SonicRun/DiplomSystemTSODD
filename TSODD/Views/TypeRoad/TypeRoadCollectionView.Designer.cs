namespace TSODD.Views.TypeRoadCollectionView {
    partial class TypeRoadCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "TypeRoad Tasks";
			...
			this.typeRoadCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.typeRoadCollectionViewBindingSource.DataSource = typeof(TSODD.Entity.Road_sign.TypeRoad);
			this.gridControl.DataSource = typeRoadCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnsParameters parameters = new DevExpress.XtraGrid.Extensions.PopulateColumnsParameters();
						...
						this.gridView.PopulateColumns(typeof(TSODD.Entity.Road_sign.TypeRoad),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.TypeRoadCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.TypeRoadCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.TypeRoadCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.TypeRoadCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.TypeRoadCollectionViewModel), "Refresh", bbiRefresh));
            ...
            this.Name = "TypeRoadCollectionView";
		...
		private System.Windows.Forms.BindingSource typeRoadCollectionViewBindingSource;
