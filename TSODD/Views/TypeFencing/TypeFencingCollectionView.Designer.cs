namespace TSODD.Views.TypeFencingCollectionView {
    partial class TypeFencingCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "TypeFencing Tasks";
			...
			this.typeFencingCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.typeFencingCollectionViewBindingSource.DataSource = typeof(TSODD.Entity.Fencing.TypeFencing);
			this.gridControl.DataSource = typeFencingCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnsParameters parameters = new DevExpress.XtraGrid.Extensions.PopulateColumnsParameters();
						...
						this.gridView.PopulateColumns(typeof(TSODD.Entity.Fencing.TypeFencing),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.TypeFencingCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.TypeFencingCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.TypeFencingCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.TypeFencingCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.TypeFencingCollectionViewModel), "Refresh", bbiRefresh));
            ...
            this.Name = "TypeFencingCollectionView";
		...
		private System.Windows.Forms.BindingSource typeFencingCollectionViewBindingSource;
