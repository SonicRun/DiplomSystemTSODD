namespace TSODD.Views.DegreeOfCapacityStopsCollectionView {
    partial class DegreeOfCapacityStopsCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "DegreeOfCapacityStops Tasks";
			...
			this.degreeOfCapacityStopsCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.degreeOfCapacityStopsCollectionViewBindingSource.DataSource = typeof(TSODD.Entity.Public_transport_stop.DegreeOfCapacityStops);
			this.gridControl.DataSource = degreeOfCapacityStopsCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnsParameters parameters = new DevExpress.XtraGrid.Extensions.PopulateColumnsParameters();
						...
						this.gridView.PopulateColumns(typeof(TSODD.Entity.Public_transport_stop.DegreeOfCapacityStops),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.DegreeOfCapacityStopsCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.DegreeOfCapacityStopsCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.DegreeOfCapacityStopsCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.DegreeOfCapacityStopsCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.DegreeOfCapacityStopsCollectionViewModel), "Refresh", bbiRefresh));
			...
			//
			//DegreeOfCapacityStopsCollectionView
			//
            ...
            this.Name = "DegreeOfCapacityStopsCollectionView";
		...
		private System.Windows.Forms.BindingSource degreeOfCapacityStopsCollectionViewBindingSource;
