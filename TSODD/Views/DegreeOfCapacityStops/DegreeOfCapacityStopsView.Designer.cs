namespace TSODD.Views.DegreeOfCapacityStopsView {
    partial class DegreeOfCapacityStopsView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.mainRibbonPageGroup.Text = "DegreeOfCapacityStops Tasks";
			// 
			...
			this.degreeOfCapacityStopsViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.degreeOfCapacityStopsViewBindingSource.DataSource = typeof(TSODD.Entity.Public_transport_stop.DegreeOfCapacityStops);
			this.dataLayoutControl1.DataSource = degreeOfCapacityStopsViewBindingSource;
			//
			//Create GridControls
			//
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.DegreeOfCapacityStopsViewModel);
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.DegreeOfCapacityStopsViewModel), "Save", bbiSave));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.DegreeOfCapacityStopsViewModel), "SaveAndClose", bbiSaveAndClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.DegreeOfCapacityStopsViewModel), "SaveAndNew", bbiSaveAndNew));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.DegreeOfCapacityStopsViewModel), "Reset", bbiReset));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.DegreeOfCapacityStopsViewModel), "Delete", bbiDelete));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.DegreeOfCapacityStopsViewModel), "Close", bbiClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.DegreeOfCapacityStopsViewModel), "SaveLayout", bbiSaveLayout));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.DegreeOfCapacityStopsViewModel), "ResetLayout", bbiResetLayout));
            ...
            this.Name = "DegreeOfCapacityStopsView";
		...
		private System.Windows.Forms.BindingSource degreeOfCapacityStopsViewBindingSource;
