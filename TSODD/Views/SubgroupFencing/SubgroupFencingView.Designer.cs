namespace TSODD.Views.SubgroupFencingView {
    partial class SubgroupFencingView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.mainRibbonPageGroup.Text = "SubgroupFencing Tasks";
			// 
			...
			this.subgroupFencingViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.subgroupFencingViewBindingSource.DataSource = typeof(TSODD.Entity.Fencing.SubgroupFencing);
			this.dataLayoutControl1.DataSource = subgroupFencingViewBindingSource;
			//
			//Create GridControls
			//
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.SubgroupFencingViewModel);
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.SubgroupFencingViewModel), "Save", bbiSave));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.SubgroupFencingViewModel), "SaveAndClose", bbiSaveAndClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.SubgroupFencingViewModel), "SaveAndNew", bbiSaveAndNew));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.SubgroupFencingViewModel), "Reset", bbiReset));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.SubgroupFencingViewModel), "Delete", bbiDelete));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.SubgroupFencingViewModel), "Close", bbiClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.SubgroupFencingViewModel), "SaveLayout", bbiSaveLayout));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.SubgroupFencingViewModel), "ResetLayout", bbiResetLayout));
		...
		private System.Windows.Forms.BindingSource subgroupFencingViewBindingSource;
