namespace TSODD.Views.SubgroupFencingCollectionView {
    partial class SubgroupFencingCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "SubgroupFencing Tasks";
			...
			this.subgroupFencingCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.subgroupFencingCollectionViewBindingSource.DataSource = typeof(TSODD.Entity.Fencing.SubgroupFencing);
			this.gridControl.DataSource = subgroupFencingCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnsParameters parameters = new DevExpress.XtraGrid.Extensions.PopulateColumnsParameters();
						...
						this.gridView.PopulateColumns(typeof(TSODD.Entity.Fencing.SubgroupFencing),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.SubgroupFencingCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.SubgroupFencingCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.SubgroupFencingCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.SubgroupFencingCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.SubgroupFencingCollectionViewModel), "Refresh", bbiRefresh));
            ...
            this.Name = "SubgroupFencingCollectionView";
		...
		private System.Windows.Forms.BindingSource subgroupFencingCollectionViewBindingSource;
