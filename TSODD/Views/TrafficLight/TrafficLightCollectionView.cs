...
namespace TSODD.Views.TrafficLightCollectionView{
    public partial class TrafficLightCollectionView : XtraUserControl {
        public TrafficLightCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<TSODD.ViewModels.TrafficLightCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as TSODD.Entity.Traffic_light.TrafficLight,
