...
namespace TSODD.Views.RoadSignCollectionView{
    public partial class RoadSignCollectionView : XtraUserControl {
        public RoadSignCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<TSODD.ViewModels.RoadSignCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as TSODD.Entity.Road_sign.RoadSign,
