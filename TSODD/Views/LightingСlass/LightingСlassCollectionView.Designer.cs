namespace TSODD.Views.LightingСlassCollectionView {
    partial class LightingСlassCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "LightingСlass Tasks";
			...
			this.lightingСlassCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.lightingСlassCollectionViewBindingSource.DataSource = typeof(TSODD.Entity.Lamp.LightingСlass);
			this.gridControl.DataSource = lightingСlassCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnsParameters parameters = new DevExpress.XtraGrid.Extensions.PopulateColumnsParameters();
						...
						this.gridView.PopulateColumns(typeof(TSODD.Entity.Lamp.LightingСlass),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.LightingСlassCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.LightingСlassCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.LightingСlassCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.LightingСlassCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.LightingСlassCollectionViewModel), "Refresh", bbiRefresh));
            ...
            this.Name = "LightingСlassCollectionView";
		...
		private System.Windows.Forms.BindingSource lightingСlassCollectionViewBindingSource;
