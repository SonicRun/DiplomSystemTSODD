...
namespace TSODD.Views.StreetLightCollectionView{
    public partial class StreetLightCollectionView : XtraUserControl {
        public StreetLightCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<TSODD.ViewModels.StreetLightCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as TSODD.Entity.Lamp.StreetLight,
