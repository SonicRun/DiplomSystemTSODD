namespace TSODD.Views.VariantOfTrafficLightDesignCollectionView {
    partial class VariantOfTrafficLightDesignCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "VariantOfTrafficLightDesign Tasks";
			...
			this.variantOfTrafficLightDesignCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.variantOfTrafficLightDesignCollectionViewBindingSource.DataSource = typeof(TSODD.Entity.Traffic_light.VariantOfTrafficLightDesign);
			this.gridControl.DataSource = variantOfTrafficLightDesignCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnsParameters parameters = new DevExpress.XtraGrid.Extensions.PopulateColumnsParameters();
						...
						this.gridView.PopulateColumns(typeof(TSODD.Entity.Traffic_light.VariantOfTrafficLightDesign),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.VariantOfTrafficLightDesignCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.VariantOfTrafficLightDesignCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.VariantOfTrafficLightDesignCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.VariantOfTrafficLightDesignCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.VariantOfTrafficLightDesignCollectionViewModel), "Refresh", bbiRefresh));
			...
			//
			//VariantOfTrafficLightDesignCollectionView
			//
            ...
            this.Name = "VariantOfTrafficLightDesignCollectionView";
		...
		private System.Windows.Forms.BindingSource variantOfTrafficLightDesignCollectionViewBindingSource;
