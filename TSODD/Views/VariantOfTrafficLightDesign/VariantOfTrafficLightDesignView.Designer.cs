namespace TSODD.Views.VariantOfTrafficLightDesignView {
    partial class VariantOfTrafficLightDesignView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.mainRibbonPageGroup.Text = "VariantOfTrafficLightDesign Tasks";
			// 
			...
			this.variantOfTrafficLightDesignViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.variantOfTrafficLightDesignViewBindingSource.DataSource = typeof(TSODD.Entity.Traffic_light.VariantOfTrafficLightDesign);
			this.dataLayoutControl1.DataSource = variantOfTrafficLightDesignViewBindingSource;
			//
			//Create GridControls
			//
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.VariantOfTrafficLightDesignViewModel);
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.VariantOfTrafficLightDesignViewModel), "Save", bbiSave));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.VariantOfTrafficLightDesignViewModel), "SaveAndClose", bbiSaveAndClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.VariantOfTrafficLightDesignViewModel), "SaveAndNew", bbiSaveAndNew));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.VariantOfTrafficLightDesignViewModel), "Reset", bbiReset));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.VariantOfTrafficLightDesignViewModel), "Delete", bbiDelete));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.VariantOfTrafficLightDesignViewModel), "Close", bbiClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.VariantOfTrafficLightDesignViewModel), "SaveLayout", bbiSaveLayout));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.VariantOfTrafficLightDesignViewModel), "ResetLayout", bbiResetLayout));
			...
			//
			//VariantOfTrafficLightDesignView
			//
            ...
            this.Name = "VariantOfTrafficLightDesignView";
		...
		private System.Windows.Forms.BindingSource variantOfTrafficLightDesignViewBindingSource;
