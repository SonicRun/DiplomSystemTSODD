...
namespace TSODD.Views.ConditionOfTheObjectCollectionView{
    public partial class ConditionOfTheObjectCollectionView : XtraUserControl {
        public ConditionOfTheObjectCollectionView() {
            InitializeComponent();
			 if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<TSODD.ViewModels.ConditionOfTheObjectCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as TSODD.Entity.ConditionOfTheObject,
