namespace TSODD.Views.ConditionOfTheObjectCollectionView {
    partial class ConditionOfTheObjectCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "ConditionOfTheObject Tasks";
			...
			this.conditionOfTheObjectCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.conditionOfTheObjectCollectionViewBindingSource.DataSource = typeof(TSODD.Entity.ConditionOfTheObject);
			this.gridControl.DataSource = conditionOfTheObjectCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnsParameters parameters = new DevExpress.XtraGrid.Extensions.PopulateColumnsParameters();
						...
						this.gridView.PopulateColumns(typeof(TSODD.Entity.ConditionOfTheObject),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.ConditionOfTheObjectCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.ConditionOfTheObjectCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.ConditionOfTheObjectCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.ConditionOfTheObjectCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.ConditionOfTheObjectCollectionViewModel), "Refresh", bbiRefresh));
			...
			//
			//ConditionOfTheObjectCollectionView
			//
            ...
            this.Name = "ConditionOfTheObjectCollectionView";
		...
		private System.Windows.Forms.BindingSource conditionOfTheObjectCollectionViewBindingSource;
