namespace TSODD.Views.ConditionOfTheObjectView {
    partial class ConditionOfTheObjectView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.mainRibbonPageGroup.Text = "ConditionOfTheObject Tasks";
			// 
			...
			this.conditionOfTheObjectViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.conditionOfTheObjectViewBindingSource.DataSource = typeof(TSODD.Entity.ConditionOfTheObject);
			this.dataLayoutControl1.DataSource = conditionOfTheObjectViewBindingSource;
			//
			//Create GridControls
			//
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.ConditionOfTheObjectViewModel);
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.ConditionOfTheObjectViewModel), "Save", bbiSave));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.ConditionOfTheObjectViewModel), "SaveAndClose", bbiSaveAndClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.ConditionOfTheObjectViewModel), "SaveAndNew", bbiSaveAndNew));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.ConditionOfTheObjectViewModel), "Reset", bbiReset));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.ConditionOfTheObjectViewModel), "Delete", bbiDelete));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.ConditionOfTheObjectViewModel), "Close", bbiClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.ConditionOfTheObjectViewModel), "SaveLayout", bbiSaveLayout));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.ConditionOfTheObjectViewModel), "ResetLayout", bbiResetLayout));
            ...
            this.Name = "ConditionOfTheObjectView";
		...
		private System.Windows.Forms.BindingSource conditionOfTheObjectViewBindingSource;
