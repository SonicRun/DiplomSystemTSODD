...
namespace TSODD.Views.PublicTransportStopCollectionView{
    public partial class PublicTransportStopCollectionView : XtraUserControl {
        public PublicTransportStopCollectionView() {
            InitializeComponent();
        ...
        void InitBindings() {
            ...
            var fluentAPI = mvvmContext.OfType<TSODD.ViewModels.PublicTransportStopCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as TSODD.Entity.Public_transport_stop.PublicTransportStop,
