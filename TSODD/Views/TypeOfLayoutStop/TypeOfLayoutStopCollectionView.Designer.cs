namespace TSODD.Views.TypeOfLayoutStopCollectionView {
    partial class TypeOfLayoutStopCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "TypeOfLayoutStop Tasks";
			...
			this.typeOfLayoutStopCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.typeOfLayoutStopCollectionViewBindingSource.DataSource = typeof(TSODD.Entity.Public_transport_stop.TypeOfLayoutStop);
			this.gridControl.DataSource = typeOfLayoutStopCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnsParameters parameters = new DevExpress.XtraGrid.Extensions.PopulateColumnsParameters();
						...
						this.gridView.PopulateColumns(typeof(TSODD.Entity.Public_transport_stop.TypeOfLayoutStop),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.TypeOfLayoutStopCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.TypeOfLayoutStopCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.TypeOfLayoutStopCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.TypeOfLayoutStopCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.TypeOfLayoutStopCollectionViewModel), "Refresh", bbiRefresh));
			...
			//
			//TypeOfLayoutStopCollectionView
			//
            ...
            this.Name = "TypeOfLayoutStopCollectionView";
		...
		private System.Windows.Forms.BindingSource typeOfLayoutStopCollectionViewBindingSource;
