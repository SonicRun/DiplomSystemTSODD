namespace TSODD.Views.PhotoCollectionView {
    partial class PhotoCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "Photo Tasks";
			...
			this.photoCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.photoCollectionViewBindingSource.DataSource = typeof(TSODD.Entity.Photo);
			this.gridControl.DataSource = photoCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnsParameters parameters = new DevExpress.XtraGrid.Extensions.PopulateColumnsParameters();
						...
						this.gridView.PopulateColumns(typeof(TSODD.Entity.Photo),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.PhotoCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.PhotoCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.PhotoCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.PhotoCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.PhotoCollectionViewModel), "Refresh", bbiRefresh));
		...
		private System.Windows.Forms.BindingSource photoCollectionViewBindingSource;
