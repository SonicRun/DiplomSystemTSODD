...
namespace TSODD.Views.PhotoCollectionView{
    public partial class PhotoCollectionView : XtraUserControl {
        ...
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<TSODD.ViewModels.PhotoCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as TSODD.Entity.Photo,
