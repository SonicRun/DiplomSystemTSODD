namespace TSODD.Views.GroupFencingView {
    partial class GroupFencingView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.mainRibbonPageGroup.Text = "GroupFencing Tasks";
			// 
			...
			this.groupFencingViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.groupFencingViewBindingSource.DataSource = typeof(TSODD.Entity.Fencing.GroupFencing);
			this.dataLayoutControl1.DataSource = groupFencingViewBindingSource;
			//
			//Create GridControls
			//
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.GroupFencingViewModel);
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.GroupFencingViewModel), "Save", bbiSave));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.GroupFencingViewModel), "SaveAndClose", bbiSaveAndClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.GroupFencingViewModel), "SaveAndNew", bbiSaveAndNew));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.GroupFencingViewModel), "Reset", bbiReset));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.GroupFencingViewModel), "Delete", bbiDelete));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.GroupFencingViewModel), "Close", bbiClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.GroupFencingViewModel), "SaveLayout", bbiSaveLayout));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.GroupFencingViewModel), "ResetLayout", bbiResetLayout));
		...
		private System.Windows.Forms.BindingSource groupFencingViewBindingSource;
