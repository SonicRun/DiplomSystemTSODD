namespace TSODD.Views.GroupFencingCollectionView {
    partial class GroupFencingCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "GroupFencing Tasks";
			...
			this.groupFencingCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.groupFencingCollectionViewBindingSource.DataSource = typeof(TSODD.Entity.Fencing.GroupFencing);
			this.gridControl.DataSource = groupFencingCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnsParameters parameters = new DevExpress.XtraGrid.Extensions.PopulateColumnsParameters();
						...
						this.gridView.PopulateColumns(typeof(TSODD.Entity.Fencing.GroupFencing),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.GroupFencingCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.GroupFencingCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.GroupFencingCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.GroupFencingCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.GroupFencingCollectionViewModel), "Refresh", bbiRefresh));
            ...
            this.Name = "GroupFencingCollectionView";
		...
		private System.Windows.Forms.BindingSource groupFencingCollectionViewBindingSource;
