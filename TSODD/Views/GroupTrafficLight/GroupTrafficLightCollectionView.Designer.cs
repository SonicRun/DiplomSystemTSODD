namespace TSODD.Views.GroupTrafficLightCollectionView {
    partial class GroupTrafficLightCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "GroupTrafficLight Tasks";
			...
			this.groupTrafficLightCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.groupTrafficLightCollectionViewBindingSource.DataSource = typeof(TSODD.Entity.Traffic_light.GroupTrafficLight);
			this.gridControl.DataSource = groupTrafficLightCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnsParameters parameters = new DevExpress.XtraGrid.Extensions.PopulateColumnsParameters();
						...
						this.gridView.PopulateColumns(typeof(TSODD.Entity.Traffic_light.GroupTrafficLight),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.GroupTrafficLightCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.GroupTrafficLightCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.GroupTrafficLightCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.GroupTrafficLightCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.GroupTrafficLightCollectionViewModel), "Refresh", bbiRefresh));
			...
			//
			//GroupTrafficLightCollectionView
			//
            ...
            this.Name = "GroupTrafficLightCollectionView";
		...
		private System.Windows.Forms.BindingSource groupTrafficLightCollectionViewBindingSource;
