namespace TSODD.Views.FencingСlassCollectionView {
    partial class FencingСlassCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "FencingСlass Tasks";
			...
			this.fencingСlassCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.fencingСlassCollectionViewBindingSource.DataSource = typeof(TSODD.Entity.FencingСlass);
			this.gridControl.DataSource = fencingСlassCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnsParameters parameters = new DevExpress.XtraGrid.Extensions.PopulateColumnsParameters();
						...
						this.gridView.PopulateColumns(typeof(TSODD.Entity.FencingСlass),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.FencingСlassCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.FencingСlassCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.FencingСlassCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.FencingСlassCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.FencingСlassCollectionViewModel), "Refresh", bbiRefresh));
            ...
            this.Name = "FencingСlassCollectionView";
		...
		private System.Windows.Forms.BindingSource fencingСlassCollectionViewBindingSource;
