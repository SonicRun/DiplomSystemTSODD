namespace TSODD.Views.TypeTrafficLightCollectionView {
    partial class TypeTrafficLightCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "TypeTrafficLight Tasks";
			...
			this.typeTrafficLightCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.typeTrafficLightCollectionViewBindingSource.DataSource = typeof(TSODD.Entity.Traffic_light.TypeTrafficLight);
			this.gridControl.DataSource = typeTrafficLightCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnsParameters parameters = new DevExpress.XtraGrid.Extensions.PopulateColumnsParameters();
						...
						this.gridView.PopulateColumns(typeof(TSODD.Entity.Traffic_light.TypeTrafficLight),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.TypeTrafficLightCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.TypeTrafficLightCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.TypeTrafficLightCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.TypeTrafficLightCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.TypeTrafficLightCollectionViewModel), "Refresh", bbiRefresh));
			...
			//
			//TypeTrafficLightCollectionView
			//
            ...
            this.Name = "TypeTrafficLightCollectionView";
		...
		private System.Windows.Forms.BindingSource typeTrafficLightCollectionViewBindingSource;
