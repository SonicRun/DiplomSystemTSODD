namespace TSODD.Views.GeographicalPositionCollectionView {
    partial class GeographicalPositionCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "GeographicalPosition Tasks";
			...
			this.geographicalPositionCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.geographicalPositionCollectionViewBindingSource.DataSource = typeof(TSODD.Entity.GeographicalPosition);
			this.gridControl.DataSource = geographicalPositionCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnsParameters parameters = new DevExpress.XtraGrid.Extensions.PopulateColumnsParameters();
						...
						this.gridView.PopulateColumns(typeof(TSODD.Entity.GeographicalPosition),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.GeographicalPositionCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.GeographicalPositionCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.GeographicalPositionCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.GeographicalPositionCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.GeographicalPositionCollectionViewModel), "Refresh", bbiRefresh));
			...
			//
			//GeographicalPositionCollectionView
			//
            ...
            this.Name = "GeographicalPositionCollectionView";
		...
		private System.Windows.Forms.BindingSource geographicalPositionCollectionViewBindingSource;
