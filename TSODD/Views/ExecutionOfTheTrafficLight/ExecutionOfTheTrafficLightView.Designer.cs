namespace TSODD.Views.ExecutionOfTheTrafficLightView {
    partial class ExecutionOfTheTrafficLightView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.mainRibbonPageGroup.Text = "ExecutionOfTheTrafficLight Tasks";
			// 
			...
			this.executionOfTheTrafficLightViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.executionOfTheTrafficLightViewBindingSource.DataSource = typeof(TSODD.Entity.Traffic_light.ExecutionOfTheTrafficLight);
			this.dataLayoutControl1.DataSource = executionOfTheTrafficLightViewBindingSource;
			//
			//Create GridControls
			//
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.ExecutionOfTheTrafficLightViewModel);
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.ExecutionOfTheTrafficLightViewModel), "Save", bbiSave));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.ExecutionOfTheTrafficLightViewModel), "SaveAndClose", bbiSaveAndClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.ExecutionOfTheTrafficLightViewModel), "SaveAndNew", bbiSaveAndNew));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.ExecutionOfTheTrafficLightViewModel), "Reset", bbiReset));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.ExecutionOfTheTrafficLightViewModel), "Delete", bbiDelete));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.ExecutionOfTheTrafficLightViewModel), "Close", bbiClose));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.ExecutionOfTheTrafficLightViewModel), "SaveLayout", bbiSaveLayout));
						this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.ExecutionOfTheTrafficLightViewModel), "ResetLayout", bbiResetLayout));
			...
			//
			//ExecutionOfTheTrafficLightView
			//
            ...
            this.Name = "ExecutionOfTheTrafficLightView";
		...
		private System.Windows.Forms.BindingSource executionOfTheTrafficLightViewBindingSource;
