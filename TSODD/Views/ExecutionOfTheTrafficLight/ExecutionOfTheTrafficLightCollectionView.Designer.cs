namespace TSODD.Views.ExecutionOfTheTrafficLightCollectionView {
    partial class ExecutionOfTheTrafficLightCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.ribbonPageGroup1.Text = "ExecutionOfTheTrafficLight Tasks";
			...
			this.executionOfTheTrafficLightCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.executionOfTheTrafficLightCollectionViewBindingSource.DataSource = typeof(TSODD.Entity.Traffic_light.ExecutionOfTheTrafficLight);
			this.gridControl.DataSource = executionOfTheTrafficLightCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnsParameters parameters = new DevExpress.XtraGrid.Extensions.PopulateColumnsParameters();
						...
						this.gridView.PopulateColumns(typeof(TSODD.Entity.Traffic_light.ExecutionOfTheTrafficLight),parameters);
			// 
            // popupMenu1
            // 
            ...
            this.mvvmContext.ViewModelType = typeof(TSODD.ViewModels.ExecutionOfTheTrafficLightCollectionViewModel);
								this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.ExecutionOfTheTrafficLightCollectionViewModel), "New", bbiNew));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.ExecutionOfTheTrafficLightCollectionViewModel), "Edit", "SelectedEntity", bbiEdit));
			this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(typeof(TSODD.ViewModels.ExecutionOfTheTrafficLightCollectionViewModel), "Delete", "SelectedEntity", bbiDelete));
					this.mvvmContext.BindingExpressions.Add(DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(typeof(TSODD.ViewModels.ExecutionOfTheTrafficLightCollectionViewModel), "Refresh", bbiRefresh));
			...
			//
			//ExecutionOfTheTrafficLightCollectionView
			//
            ...
            this.Name = "ExecutionOfTheTrafficLightCollectionView";
		...
		private System.Windows.Forms.BindingSource executionOfTheTrafficLightCollectionViewBindingSource;
